...
SocialSharing.prototype.share = function (message, subject, fileOrFileArray, url, successCallback, errorCallback) {
  cordova.exec(successCallback, this._getErrorCallback(errorCallback, "shareViaWhatsApp","shareViaWhatsAppToReceiver","shareViaSMS"), "SocialSharing", "shareViaWhatsApp","shareViaWhatsAppToReceiver","shareViaSMS", [message, subject, this._asArray(fileOrFileArray), url]);
};
