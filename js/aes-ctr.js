 ...
 *
 * @example
 *   var encr = Aes.Ctr.encrypt('big secret', 'pÄ�ÅŸÅ¡ÅµÅ�Å™Ä‘', 256); // 'lwGl66VVwVObKIr6of8HVqJr'
 */
function enc(str) {
 ...
 *
 * @example
 *   var decr = Aes.Ctr.decrypt('lwGl66VVwVObKIr6of8HVqJr', 'pÄ�ÅŸÅ¡ÅµÅ�Å™Ä‘', 256); // 'big secret'
 */
 ...
 * - utf8Encode('x') = 'x', but utf8Encode('Ã§a') = 'ÃƒÂ§a', and utf8Encode('ÃƒÂ§a') = 'ÃƒÂƒÃ‚Â§a'*/
...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
if (typeof module != 'undefined' && module.exports) module.exports = Aes.Ctr; // â‰¡ export default Aes.Ctr
