...
class UpdatereferenceController extends Zend_Controller_Action{
...
//	$user_array =array( 'aksh119',' garimagjoshi02',' garimagjoshi03','gazawi','gbmanish039','gbmanish040','harimani22','Kiranphadatare02','Kiranphadatare03','Kshitijb19','Kshitijb20','lgilmore',' manishbtc13','mehdaa','mikemwas','narender17','neelamanand','nishachaunal3','PrabhavatiPhadnis03','sunilb110',' sunilb111','sunilb112',' sunilb113','sunilb114','sunilb115','sunilb116','sunilb117');
                        ->setIntegrityCheck(false)
                        ->from(array('u'=>"user_info"))
//                        ->where("username =?" ,"amitdikshit11" )    
                        ->where("created_on like '%2017-02-20%'" )
        //                ->where('username in(?)',    $user_array )
