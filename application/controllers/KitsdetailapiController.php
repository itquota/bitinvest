<?php
class KitsdetailapiController extends Zend_Controller_Action{
    ...
    public function indexAction()
    {
        try
        {
            ...
            $kit_result=$kits_obj->fetchAll($kits_obj->select()
                ->setIntegrityCheck(false)
                ->from(array('k'=>"kits"),array('k.id','k.username','k.kit_number','k.created_on','k.updated_on','k.status','k.invoice_id','k.contract_id','k.kit_price','k.kit_price_in_mcap','k.kit_used_by','k.kit_used_date','k.kit_type','k.kit_share_status','k.kit_shared_with'))
                ->joinInner(array('k1'=>'kit_invoices'),"k.invoice_id = k1.invoice_id",array('k1.kits_qty','k1.confirmations'))
