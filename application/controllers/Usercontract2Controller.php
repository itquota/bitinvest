<?php
class Usercontract2Controller extends Zend_Controller_Action{
    ...
    public function indexAction()
    {
        ...
        try
        {
            ...
            $inv_obj = new Gbc_Model_DbTable_Gb2Invoices();
            ...
            $invoices_obj = $inv_obj->fetchAll($inv_obj->select()
              //  ->where("1=1 AND username = ? AND contract_type in ('SHA','hardware')",$username)
                ->where("1=1 AND username = ? AND contract_type in ('gb2')",$username)
                ->order("invoice_id DESC")
            );
    ...
    public function contractAction()
    {
        ...
        try{
            ...
            $invoiceobj = new Gbc_Model_DbTable_Gb2Invoices();
            $contractobj = new Gbc_Model_DbTable_Gb2Contracts();
