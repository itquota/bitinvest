<?php
class TrainingsettingController extends Zend_Controller_Action{
	...
	public function indexAction()
	{
		...
		$trainingsettingObj = new Gbc_Model_DbTable_Cms();
			
		try{
				
		 $this->_helper->layout()->setLayout("admindashbord");
		 	
	 	$result=$trainingsettingObj->fetchAll($trainingsettingObj->select()
